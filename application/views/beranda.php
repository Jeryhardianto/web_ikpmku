    ...
    <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
        <ul>
            <li data-index="rs-2946" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0"
                ...
                <!-- MAIN IMAGE -->
                <img src="<?= base_url('assets/'); ?>img/home-slider/slider3.jpg" alt="" data-bgposition="center center"
                ...
                <div class="slider_text_box">
                    <div class="tp-caption tp-resizeme rev-btn first_text"
                        ...
                        data-fontsize="['12','12','12','12','12']" data-lineheight="['64','64','64','50','35']"
                        ...
                        <img src="img/play-video.png" alt=""></div>

                    <!-- LAYER NR. 10 -->
                    <div class="tp-caption   tp-resizeme tp-videolayer" id="slide-2971-layer-15"
                        ...
                        data-lasttriggerstate="reset" data-autoplay="off" data-volume="100"
                        style="z-index: 14;text-transform:left;border-width:0px;"> </div>

                    <!-- LAYER NR. 11 -->
                    <div class="tp-caption Agency-CloseBtn rev-btn " id="slide-2971-layer-20"
                        ...
                        data-width="50" data-height="none" data-whitespace="nowrap" data-type="button"
                    ...
                    <div class="tp-caption tp-resizeme secand_text"
                        data-x="['center','center','center','center','center','center']"
                        data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
                        data-voffset="['0','0','0','0','0']" data-fontsize="['30','30','30','30','30','30']"
                        ...
                        data-textAlign="['center','center','center','center','center','center']"
                        style="z-index: 5;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Website Resmi
                        <br />Ikatan Keluarga Pelajar Mahasiswa Kalimantan Utara Daerah Istimewwa Yogyakarta
                    </div>
            ...
            <li data-index="rs-2947" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0"
                ...
                data-param10="" data-description="">
                <!-- MAIN IMAGE -->
                <img src="<?= base_url('assets/'); ?>img/home-slider/slider2.jpg" alt="" data-bgposition="center center"
                    data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYER NR. 1 -->
                <div class="slider_text_box">
                    <div class="tp-caption tp-resizeme secand_text"
                        ...
                        data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:[100%];s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                        data-textAlign="['center','center','center','center','center','center']"
                        style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Berbagai
                        Informasi Kegiatan<br />Ikatan Keluarga Pelajar Mahasiswa Kalimantan Utara
                    </div>
        ...
        <div class="c_feature_box">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="c_box_item">
                        <a href="<?= base_url() ?>index.php/profil">
                            <h4><i class="fa fa-diamond" aria-hidden="true"></i>Visi</h4>
                        </a>
                ...
                <div class="col-lg-6">
                    <div class="c_box_item">
                        <a href="<?= base_url() ?>index.php/profil">
                            <h4><i class="fa fa-diamond" aria-hidden="true"></i>Misi</h4>
                        </a>

                        <p>
                            <ol>
                                <?php foreach ($visi_misi->result() as $vm) { ?>
                                <li><?php echo $vm->misi; ?> </li>
                                <?php } ?>
                            </ol>
                        </p>
                    </div>
...
<section class="testimonials_area p_100">
    <div class="container">
        ...
        <h1>Ikatan Keluarga Pelajar Mahasiswa Kalimantan Utara</h1>
        <div class="testimonials_slider owl-carousel">
            <?php foreach ($struktur->result() as $s) {  ?>
            <div class="item">
                <div class="media">
                    <img class="d-flex rounded-circle" src="<?= base_url('upload/struktur/' . $s->image) ?>" alt=""
                        width="250px" height="250px">
                    <div class="media-body">
                        <h2><?= $s->jabatan; ?></h2>
                        <h4>
                            <p><b><?= $s->nama; ?> </b>- <?= $s->jabatan; ?> IKPMKU-DIY Tahun 2019/2020</p>
                        </h4>
                    </div>
                </div>
            </div>
...
<section class="industries_area">
    <div class="container">
        <h1>Progrman Kerja</h1>
        <h1>Ikatan Keluarga Pelajar Mahasiswa Kalimantan Utara</h1><br><br>
...
<section class="industries_area">
    <div class="left_indus">
        <div class="indus_img">
            <img src="<?= base_url('assets/'); ?>img/kaltara.png" alt="">
        </div>
    </div>
    <div class="right_indus">
        <div class="indus_text">
            <div class="main_title">
                <h2>Total Pelajar Mahasiwa</h2>
                <p>Kalimantan Utara Di Daerah Istimewa Yogyakarta Berdasarakan Kabupaten dan Kota</p>
            </div>
            ...
            <div class="our_skill_inner">
                <div class="single_skill">
                    <h3><?= $m->kabupaten ?></h3>
                    <div class="progress" data-value="<?= $m->jumlah ?>">
                        <div class="progress-bar">
                            <div class="progress_parcent"><span class="counter"><?= $m->jumlah ?></span>
                                &nbsp;Pelajar/Mahasiswa</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <figure class="col-md-4">
                    <a href="<?= base_url('upload/galeri/' . $g->image) ?>" data-size="1000x950">
                        <img alt="picture" src="<?= base_url('upload/galeri/' . $g->image) ?>" class="img-fluid">
